...
class AzureContainerSAS(object):
    ...
    def __init__(self, container_name, output_file, account_name, expiry, verbosity):
...
class AzureSAS(object):
    ...
    def __init__(self, object_name, container_name, output_file, account_name, expiry, verbosity, category):
...
def cli():
    parser = ArgumentParser(
        description='Create shared access signatures (SAS) URLs for containers/files/folders in '
