...
class AzureTier(object):
    ...
    def __init__(self, object_name, container_name, account_name, storage_tier, category):
...
def file_tier(args):
    ...
    """
    logging.info(
        f'Setting the storage tier for file {args.file} in Azure container {args.container_name} to '
        f'{args.storage_tier}'
    )
...
def folder_tier(args):
    ...
    """
    logging.info(
        f'Setting the storage tier for folder {args.folder} in Azure container {args.container_name} to '
        f'{args.storage_tier}'
    )
